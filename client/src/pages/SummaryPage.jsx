      ...
      <div className="bg-light">
        ...
        <div className="container bg-light">
          ...
          <div className="row ms-1 d-flex">
            <SummaryCard
              value={summary.budget.est_income}
              sum={summary.transactionsSum(summary.incomesArr)}
              isIncome={true}
              est_id={summary.est_id}
            />
            <SummaryCard
              value={summary.budget.est_expenditure}
              sum={summary.transactionsSum(summary.expensesArr)}
              isIncome={false}
              est_id={summary.est_id}
            />
